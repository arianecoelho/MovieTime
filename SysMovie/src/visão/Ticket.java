...
public final class Ticket extends javax.swing.JFrame {
    ...
    void fecha() {
        ...
        jLabelHora.setText("Horario: " + (dia.getHours()) + ":" + (dia.getMinutes()) + ":" + (dia.getSeconds()));
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Cine Movie Time");
        ...
        jLabel13.setText("Cartao de Credito");
        ...
        jLabel15.setText("Obrigada por preferir");

        jLabel16.setFont(new java.awt.Font("Ubuntu Condensed", 1, 14)); // NOI18N
        jLabel16.setText("Cine-Movie Time");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        limpiar();
        JOptionPane.showMessageDialog(this, "Em breve!!!", "!!", JOptionPane.INFORMATION_MESSAGE);
        this.dispose();
